...
Utilizando el archivo Movie.csv implemente una Lista Doblemente Ligada de Movies (películas). La 
...
* Los procesos o funciones para contemplar son: 
   ...
   - Búsqueda de alguna película por título (puede ser nombre exacto o no) y que muestre toda la 
